		...
		<div class="view view-main">
			<div class="navbar">
				<div class="navbar-inner">
					<div class="col-75"><a href="#" data-panel="right" class="button open-panel">Menu </a></div>
			...
			<div class="pages navbar-through toolbar-through">
				<div data-page="index" class="page">
					<div class="page-content">
						<div class="content-block-title">Liste Prospect</div>
...
$(document).ready(function() 
{
	...
	$("#page_rdv").click(function(event) {
		window.location="/crm/ios/rdv/index.php";
	});
...
_('.accordion-item').on('closed', function (e) {
	...
	$.getJSON('../../fonctions/contact/affiche.php', function(json, textStatus) {
		for (var i = 0; i < json.length; i++) {
		
		data=json[i];
			$("#liste_contact").append('<li class="accordion-item"><a href="#" class="item-content item-link"><div class="item-inner"><div class="item-title">'+data.nom_contact+'</div></div></a><div class="accordion-item-content"><div class="content-block"><div>id : '+data.id+'</div><div>nom : '+data.nom_contact+'</div><div>email: '+data.email+'</div><div>téléphone : '+data.tel+'</div><div>fax : '+data.fax+'</div><div>poste : '+data.poste+'</div><div>prospect : '+data.nom_prospect+'</div><div onclick="modifier('+data.id+')" style="color:blue;cursor:pointer"><span  class="modifier" data-id="'+data.id+'">modifier</span></div></li>');};
	})
	});
</script>
</body>
