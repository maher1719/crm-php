			...
			<script>
				$(document).ready(function() {
					...
					$("form").submit(function(event) {
						...
						$.post('../../fonctions/appelles/ajout.php', {user_id:<?php echo $_SESSION["id"] ?>,date:$date.val(),id_contact:$contact.val(),commentaire:$commentaire.val(),resultat:$resultat.val()}, function(data, textStatus, xhr) {
							console.log(data);
                    data=$.parseJSON(data);
