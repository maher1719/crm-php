...
<div data-theme="b" data-role="page" data-url="/n/index.php?key=oGt48M2y&amp;embedded=1" tabindex="0" class="ui-page ui-page-theme-b ui-page-active" style="">
            <div class="ui-controlgroup ui-controlgroup-vertical ui-corner-all" id="popupChoice" data-role="controlgroup" style="left: 88px; top: 284px;"><div class="ui-controlgroup-controls "><a href="#" nodeid="1" class="aChoice ui-btn ui-corner-all  ui-first-child ">Play</a></div></div></div>
      <div style="min-height: 976px;" class="content-wrapper">
        ...
        $(document).ready(function() {
          setTimeout(responsiveVoice.speak('bienvenu'), 5000) ;
        });
        </script>
