    ...
    <script>
      $(document).ready(function() {
        ...
        $enregistrer.click(function(event) {
          ...
          $.post('../fonctions/contact/ajout.php', {user_id:<?php echo $_SESSION['id'] ?>,nom:$nom.val(),prenom:$prenom.val(),email:$email.val(),tel:$tel.val(),post:$post.val(),prospect:$prospect.val()}, function(data, textStatus, xhr) {
            /*optional stuff to do after success */alert(data);
          });
        });
      });
    </script>
