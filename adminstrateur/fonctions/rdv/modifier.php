...
if(isset($_POST["id"])&&isset($_POST["user_id"])&&isset($_POST["commentaire"])&&isset($_POST["date"])&&($_POST["date_rdv"])&&isset($_POST["id_contact"])&&isset($_POST["lieu_rdv"])&&isset($_POST["resultat"]))
{
		$rdv=new rdv();
	$prospet=new Contact();
	$rdv->id=$_POST["id"];
